...
$sql = "SELECT name, type FROM Animal WHERE wish = 1";
...
<div class="container d-flex justify-content-center align-items-center flex-column" style="height: 100vh">
    <h1 class="text-center mb-5">Wish List</h1>
    ...
    <a href="owned-list.php"><button class="btn btn-dark mt-5">Owned animals</button></a>
</div>
